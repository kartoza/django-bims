### Source from https://github.com/GeoNode/geonode/blob/master/geonode/base/management/commands/restore.py
# -*- coding: utf-8 -*-
#########################################################################
#
...
from geonode.base.management.commands.helpers import Config

from distutils import dir_util
from requests.auth import HTTPBasicAuth

from geonode import utils as geonode_utils
    ...
    def handle(self, **options):
        ...
        if force_exec or helpers.confirm(prompt=message, resp=False):
            ...
            try:
                ...
                geonode_utils.signals_store = signals_store
                designals()
                # designals()
                print "...done!"
