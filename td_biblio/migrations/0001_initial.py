# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-08-01 06:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[(b'article', 'Article'), (b'book', 'Book'), (b'booklet', 'Book (no publisher)'), (b'conference', 'Conference'), (b'inbook', 'Book chapter'), (b'incollection', 'Book from a collection'), (b'inproceedings', 'Conference proceedings article'), (b'manual', 'Technical documentation'), (b'mastersthesis', "Master's Thesis"), (b'misc', 'Miscellaneous'), (b'phdthesis', 'PhD Thesis'), (b'proceedings', 'Conference proceedings'), (b'techreport', 'Technical report'), (b'unpublished', 'Unpublished work')], default=b'article', max_length=50, verbose_name='Entry type')),
